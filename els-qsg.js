...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const interfaceButton = document.querySelector('[data-bs-target="#interfaceModal"]');
    if (interfaceButton) {
        interfaceButton.addEventListener("click", function () {
            fetch("modals/interface-modal.html")
                .then((response) => response.text())
                .then((html) => {
                    document.querySelector("#interfaceModal .modal-body").innerHTML = html;
                })
                .catch((error) => {
    ...
    const propertiesButton = document.querySelector('[data-bs-target="#secondModal"]');
    if (propertiesButton) {
        propertiesButton.addEventListener("click", function () {
            fetch("modals/properties-browser-modal.html")
                ...
                .catch((error) => {
                    console.error("Error loading properties browser modal content:", error);
                });
        });
    }

    // Handle divide with multiple planes modal
    const divideButton = document.querySelector('[data-bs-target="#divideModal"]');
    if (divideButton) {
    ...
    const copyGroupsButton = document.querySelector('[data-bs-target="#copyGroupsModal"]');
    if (copyGroupsButton) {
        copyGroupsButton.addEventListener("click", function () {
            fetch("modals/copy-groups-modal.html")
                .then((response) => response.text())
                .then((html) => {
                    document.querySelector("#copyGroupsModal .modal-body").innerHTML = html;
                })
                .catch((error) => {
    ...
    const boundaryConditionsModal = document.getElementById("boundaryConditionsModal");
    ...
    const appendElementsButton = document.querySelector('[data-bs-target="#appendElementsModal"]');
    if (appendElementsButton) {
        appendElementsButton.addEventListener("click", function () {
            fetch("modals/append-elements-modal.html")
                .then((response) => response.text())
                .then((html) => {
                    document.querySelector("#appendElementsModal .modal-body").innerHTML = html;
                })
                .catch((error) => {
    ...
    const anisotropicMaterialsModal = document.getElementById("anisotropicMaterialsModal");
    if (anisotropicMaterialsModal) {
        anisotropicMaterialsModal.addEventListener("show.bs.modal", function (event) {
            const modalBody = this.querySelector(".modal-body");
    ...
    const createLinkMemberModal = document.getElementById("createLinkMemberModal");
    ...
    const createRegionOnSegmentsModal = document.getElementById("createRegionOnSegmentsModal");
    if (createRegionOnSegmentsModal) {
        createRegionOnSegmentsModal.addEventListener("show.bs.modal", function (event) {
            const modalBody = this.querySelector(".modal-body");
    ...
    const importMaterialsStylesModal = document.getElementById("importMaterialsStylesModal");
    if (importMaterialsStylesModal) {
        importMaterialsStylesModal.addEventListener("show.bs.modal", function (event) {
            const modalBody = this.querySelector(".modal-body");
    ...
    const replaceInterfaceIdModal = document.getElementById("replaceInterfaceIdModal");
    ...
    const replaceSpringMaterialModal = document.getElementById("replaceSpringMaterialModal");
    if (replaceSpringMaterialModal) {
        replaceSpringMaterialModal.addEventListener("show.bs.modal", function (event) {
            const modalBody = this.querySelector(".modal-body");
    ...
    const styleCollectionPropertiesModal = document.getElementById("styleCollectionPropertiesModal");
    if (styleCollectionPropertiesModal) {
        styleCollectionPropertiesModal.addEventListener("show.bs.modal", function (event) {
            const modalBody = this.querySelector(".modal-body");
    ...
    const velocityVectorScaleModal = document.getElementById("velocityVectorScaleModal");
    if (velocityVectorScaleModal) {
        velocityVectorScaleModal.addEventListener("show.bs.modal", function (event) {
            const modalBody = this.querySelector(".modal-body");
    ...
    const wallStirrupExtensionsModal = document.getElementById("wallStirrupExtensionsModal");
    if (wallStirrupExtensionsModal) {
        wallStirrupExtensionsModal.addEventListener("show.bs.modal", function (event) {
            const modalBody = this.querySelector(".modal-body");
    ...
    document.querySelectorAll(".card[data-nav]").forEach(function (card) {
        card.addEventListener("mouseenter", function () {
            ...
            document.querySelectorAll("#scrollspyMenu .nav-link").forEach(function (link) {
            ...
            var navLink = document.querySelector('#scrollspyMenu .nav-link[href="' + navSelector + '"]');
